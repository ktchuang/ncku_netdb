...
public class MQTurnAroundPNewCache {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		MQTurnAroundPNewCache upq = new MQTurnAroundPNewCache(args[0],args[1],args[2],args[3]);
	...
	public MQTurnAroundPNewCache(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
