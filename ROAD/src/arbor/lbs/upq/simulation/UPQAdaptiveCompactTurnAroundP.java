...
public class UPQAdaptiveCompactTurnAroundP {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		UPQAdaptiveCompactTurnAroundP upq = new UPQAdaptiveCompactTurnAroundP(args[0],args[1],args[2],args[3]);
	...
	public UPQAdaptiveCompactTurnAroundP(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
