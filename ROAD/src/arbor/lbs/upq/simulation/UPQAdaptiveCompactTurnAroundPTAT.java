...
public class UPQAdaptiveCompactTurnAroundPTAT {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		UPQAdaptiveCompactTurnAroundPTAT upq = new UPQAdaptiveCompactTurnAroundPTAT(args[0],args[1],args[2],args[3]);
		...
		for (int l=0; l<intputSize; l++) {
    		...
    		//System.out.println(results.get(num_k-1).getDist());
    		//execTime /= 1000;
    		...
    		if (l%1000==999) {
    			double t_1 = turnAroundT_1-prevTAT_1;
    			double t_2 = turnAroundT_2-prevTAT_2;
    			double t_3 = turnAroundT_3-prevTAT_3;
    			double t_4 = turnAroundT_4-prevTAT_4;
    			
    			//out.write("UPQ Compact Turn Around Time:"+turnAroundT_1+"\n");
    			out.write(t_1+","+t_2+","+t_3+","+t_4+"\n");
    			//out.write("UPQ Compact Exec Time:"+totalExecT+"\n");
    			//System.out.println("UPQ Total Exec Time:"+totalExecT);
    			prevTAT_1 = turnAroundT_1;
    			prevTAT_2 = turnAroundT_2;
    			prevTAT_3 = turnAroundT_3;
    			prevTAT_4 = turnAroundT_4;
    		}
    		if (l>10000){
    		...
    		if (l%winSize==(winSize-1)) {
    	    	...
    	    	hqNetCnt.clear();
    	    	/*
    	    	timer.setStartTime("KNN Precomputed Time");
    	    	upq.getBorderKNN(num_k);
    	    	System.out.println(timer.setEndTime());
    	    	*/
    	    	HQNetPool.getSignleton().saveHQNets("hqnet.hq_"+l);
    		}
    		}
    	}
		out.close();
		HQNetPool.getSignleton().saveHQNets("hqnet.hq");
		System.out.println("UPQ Compact Turn Around Time1:"+turnAroundT_1);
    	System.out.println("UPQ Compact Turn Around Time2:"+turnAroundT_2);
    	System.out.println("UPQ Compact Turn Around Time3:"+turnAroundT_3);
    	System.out.println("UPQ Compact Turn Around Time4:"+turnAroundT_4);
    	System.out.println("UPQ Compact Total Exec Time:"+totalExecT);
	...
	public UPQAdaptiveCompactTurnAroundPTAT(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
