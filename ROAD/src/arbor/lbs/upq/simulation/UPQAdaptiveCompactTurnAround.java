...
public class UPQAdaptiveCompactTurnAround {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		UPQAdaptiveCompactTurnAround upq = new UPQAdaptiveCompactTurnAround(args[0],args[1],args[2],args[3]);
		...
		for (int l=0; l<intputSize; l++) {
    		...
    		if (l%winSize==(winSize-1)) {
    	    	...
    	    	System.out.println(rIDSet.size()+" "+addRIDSet.size());
	...
	public UPQAdaptiveCompactTurnAround(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
