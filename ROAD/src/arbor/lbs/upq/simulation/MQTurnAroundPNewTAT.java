...
public class MQTurnAroundPNewTAT {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		MQTurnAroundPNewTAT upq = new MQTurnAroundPNewTAT(args[0],args[1],args[2],args[3]);
	...
	public MQTurnAroundPNewTAT(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
