...
public class UPQTurnAroundPNewRange {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		UPQTurnAroundPNewRange upq = new UPQTurnAroundPNewRange(args[0],args[1],args[2],args[3]);
	...
	public UPQTurnAroundPNewRange(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
