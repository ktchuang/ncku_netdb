...
public class MQTurnAroundPNewSame {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		MQTurnAroundPNewSame upq = new MQTurnAroundPNewSame(args[0],args[1],args[2],args[3]);
	...
	public MQTurnAroundPNewSame(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
