...
public class UPQTurnAroundPNewTAT {
	//static int num_k = 5;
	...
	public static void main(String[] args) throws IOException {
		...
		UPQTurnAroundPNewTAT upq = new UPQTurnAroundPNewTAT(args[0],args[1],args[2],args[3]);
		...
		for (int l=0; l<intputSize; l++) {
    		...
    		if (l%1000==999) {
    			...
    			//out.write("UPQ Turn Around Time:"+turnAroundT_1+"\n");
		...
		out.close();
		System.out.println("UPQ Turn Around Time1:"+turnAroundT_1);
    	System.out.println("UPQ Turn Around Time2:"+turnAroundT_2);
    	System.out.println("UPQ Turn Around Time3:"+turnAroundT_3);
    	System.out.println("UPQ Turn Around Time4:"+turnAroundT_4);
    	System.out.println("UPQ Total Exec Time:"+totalExecT);
	...
	public UPQTurnAroundPNewTAT(String networkFn, String hierFn, String msgFn, String queryFn) throws IOException {
